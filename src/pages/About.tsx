            ...
            {[
              ...
              return (
                <div key={index} className="flex items-start gap-3">
                  ...
                  <p className="text-slate-600 dark:text-slate-400 pt-1.5">
                    {feature.text}
                  </p>
                </div>
              );
        ...
        <div className="bg-white dark:bg-slate-800 rounded-2xl p-8 border border-gray-200 dark:border-slate-700 shadow-lg">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            {['React 19', 'TypeScript', 'Vite', 'Tailwind CSS', 'React Router', 'JSON Server'].map((tech) => (
              <div
                key={tech}
                className="px-4 py-3 rounded-xl bg-gray-50 dark:bg-slate-900 border border-gray-200 dark:border-slate-700 text-center"
              >
